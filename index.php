...
<!-- 
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="working-process-one__single text-center">
                            <div class="icon-box">
                                <i class="icon-problem-analysis"></i>
                            ...
                            <div class="content-box">
                                <div class="title-box">
                                    <h5>First Step</h5>
                                    <h3><a href="#">Problem Analysis</a></h3>
                                </div>
                                <div class="text-box">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="working-process-one__single text-center">
                            ...
                            <div class="content-box">
                                <div class="title-box">
                                    <h5>Third Step</h5>
                                    <h3><a href="#">Build and Develop</a></h3>
                                </div>
                                <div class="text-box">
                                    <p>All trials are our Pro plan by default you can try out all features.</p>
                                </div>
        ...
        <section class="blog-three">
            <div class="blog-three__shape1 float-bob-y">
                <img src="assets/img/shape/blog-three__shape1.png" alt="shapes">
            </div>
            <div class="blog-three__shape2">
