...
if (isset($_POST['edit_blog'])) 
{
    ...
    $q= $mysqli -> query("select * from event where bid =".$_GET['bid']); 
    ...
    $pro_q = $mysqli -> query("update event set title='$title',description='$description',img='$path' where bid =".$_GET['bid']);
