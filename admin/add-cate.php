...
if (isset($_POST['add_cate'])) 
{
    ...
    $pro_q = $mysqli -> query("INSERT INTO gal_cate(cid,name) VALUES ('','$name')");
                                            ...
                                            <tbody>
                                                ...
                                                while($row =  $q -> fetch_array(MYSQLI_ASSOC))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="delete_cate.php?cid=<?php echo $row['cid'];?>" style="color: #123456"><i class="far fa-trash-alt"></i></a></td>
                                                    </tr>
                                                    <?php
                                                } 
                                                ?>
