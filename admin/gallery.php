...
if (isset($_POST['add-gallery'])) 
{
    ...
    $target_dir = "assets\upload\gallery";
    $target_file = $target_dir . basename($_FILES["img"]["name"]);
    $imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));

    $tmp_name=$_FILES["img"]["tmp_name"];
    $path="assets/upload/gallery/".rand().$_FILES["img"]["name"]; 
    ...
    $pro_q = $mysqli -> query("INSERT INTO gallery(gid,cid,img) VALUES ('','$cid','$path')");
                                    ...
                                    <form method="post" action="" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                               ...
                                               <?php
                                               $q= $mysqli -> query("select * from gal_cate");
                                               ?>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <?php 
                                    $qy= $mysqli -> query("select * from gallery");
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card">
                                              ...
                                              <div class="card-body">
                                                 ...
                                                 $qr= $mysqli -> query("select * from gal_cate where cid =".$row['cid']);

                                                 $r = $qr -> fetch_array(MYSQLI_ASSOC)
                                                 ?>

                                                 <h6 style="text-align: center;">Category : <?php echo $r['name']  ?></h6>
                                                 <a href="delete_gallery.php?gid=<?php echo $row['gid'];?>" style="display: block; margin: 0 auto;" class="btn btn-primary"><i class="far fa-trash-alt"></i> Delete</a>
                                             </div>
                                         </div>
                                     </div>
                                     <?php
