            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        ...
                        <p class="m-b-0">Welcome to Linking Digital</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                               ...
                               <div class="card-block">
                                   <div class="row">
                                       <div class="col-3 text-center  bg-c-blue">
                                        <i class="mat-icon fa fa-product-hunt f-24"></i>
                                    </div>
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-3 text-center bg-c-green">
                                    <i class="fa fa-picture-o mat-icon f-24"></i>
                                </div>
                                <div class="col-9 cst-cont">
                                    <h5>
                                        <?php
                ...
                <div class="col-xl-4 col-md-12">
                   <div class="card mat-clr-stat-card text-white blue">
                       <div class="card-block">
                           <div class="row">
                               <div class="col-3 text-center  bg-c-blue">
                                   <i class=" mat-icon fa fa-list f-24"></i>
                               </div>
                               <div class="col-9 cst-cont">
                                   <h5> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-9 cst-cont">
                                <h5>
                                    ...
                                    $qp= $mysqli -> query("select * from testi");
                                    echo mysqli_num_rows($qp);
