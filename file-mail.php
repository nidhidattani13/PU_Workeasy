    ...
    $message = '
		...
		<table border="1" width="100%" cellpadding="5" cellspacing="5">
			...
			<tr>
				...
				<td width="70%">' . $_POST["cn"] . '</td>
			</tr>
			<tr>
				<td width="30%">Date</td>
				<td width="70%">' . $_POST["date"] . '</td>
			</tr>
			<tr>
				<td width="30%">Time</td>
				<td width="70%">' . $_POST["time"] . '</td>
			</tr>
			<tr>
...
// ADD YOUR DETAILS HERE
    ...
    $mail->Password = 'mmnkerruykyjiupj';                    //Sets SMTP password
    $mail->SMTPSecure = 'ssl';                            //Sets connection prefix. Options are "", "ssl" or "tls"
    $mail->From = 'workeasy.enquiry.send@gmail.com';                    //Sets the From email address for the message
    $mail->FromName = 'Work Easy';                //Sets the From name of the message
    $mail->AddAddress('workeasy.enquiry.receive@gmail.com', 'Work Easy');        //Adds a "To" address
// ADD YOUR DETAILS HERE
