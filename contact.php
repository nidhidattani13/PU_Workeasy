                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="contact-page__btn">
                                        <!-- <button class="thm-btn" name="submit" value="submit" type="submit" data-loading-text="Please wait...">
                                            <span class="txt">
                                                Send Message
                                            </span>
                                        </button> -->
                                        <input style="width: 100%; background: #2c587d; color: #ffffff" class="main-btn main-btn-2 mt-10" type="submit" name="submit" value="Submit">
